...
""" unit tests NetApp StorageGRID Login Ansible module: na_sg_grid_login"""
...
from ansible_collections.netapp.storagegrid.plugins.modules.na_sg_grid_login import (
    SgLogin as grid_login_module,
)
...
SRR = {
    ...
    "api_response_auth_generated": (
        {
            "data": "c0a4f224-3765-2aa9-9980-f305d37a725f"
        },
        None,
    ),
}
...
class TestMyModule(unittest.TestCase):
    ...
    def set_args_create_na_sg_grid_login_pass_check(self):
        return dict(
            {
                "hostname": "0.0.0.0",
                "username": "root",
    ...
    @patch("ansible_collections.netapp.storagegrid.plugins.module_utils.netapp.SGAuthGenRestAPI.send_request")
    def test_create_na_sg_grid_login_pass(self, mock_request):
