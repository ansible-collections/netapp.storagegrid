...
SRR = {
    ...
    'grid_admin_proxy': ({'data': {}}, None),
    'grid_alarms': ({'data': []}, None),
    'grid_audit': ({'data': {}}, None),
    'grid_audit_destinations': ({'data': {}}, None),
    'grid_autosupport': ({'data': {}}, None),
...
class TestMyModule(unittest.TestCase):
    ...
    def test_run_sg_gather_facts_for_all_info_pass(self, mock_request):
        ...
        mock_request.side_effect = [
            SRR['version_114'],
            SRR['grid_accounts'],
            SRR['grid_admin_proxy'],
            SRR['grid_alarms'],
            SRR['grid_audit'],
            SRR['grid_audit_destinations'],
            SRR['grid_autosupport'],
